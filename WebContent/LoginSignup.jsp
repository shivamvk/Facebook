  ...
  <div id="contentwrapper">
    <div id="content">
      ...
      <div id="rightbod">
        ...
        <form action="" method="post" onsubmit="signupfunction(event)">
        <div class="formbox">
        <input type="text" id="firstName" class="inputbody in1" placeholder="First name" required="required">
        <input type="text" id="lastName" class="inputbody in1 fr" placeholder="Last name" required="required">
        </div>
        <div class="formbox">
        <input type="email" id="email" class="inputbody in2" placeholder="Email" required="required">
        </div>
        <div class="formbox">
        <input type="email" class="inputbody in2" placeholder="Re-enter email" required="required">
        </div>
        <div class="formbox">
        <input type="password" id="password" class="inputbody in2" placeholder="New password" required="required">
        </div>
        <div class="formbox">
        ...
        <div class="formbox">
          <span data-type="selectors">
            <span>
              <select id="dobMonth" required="required" title="Month" class="selectbody"><option value="0" selected="1">Month</option><option value="1">Jan</option><option value="2">Feb</option><option value="3">Mar</option><option value="4">Apr</option><option value="5">May</option><option value="6">Jun</option><option value="7">Jul</option><option value="8">Aug</option><option value="9">Sep</option><option value="10">Oct</option><option value="11">Nov</option><option value="12">Dec</option></select>
              <select id="dobDay" required="required" title="Day" class="selectbody fl"><option value="0" selected="1">Day</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option></select>
            ...
            <div class="formbox mt1">
              <span data-type="radio" class="spanpad">
                <input required="" name="gender" value="Female" type="radio" id="fem" class="m0">
                <label for="fem" class="gender">Female
                </label>
                <input required="" name="gender" value="Male" type="radio" id="male" class="m0">
